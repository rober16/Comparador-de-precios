...
@XmlRootElement(name = "ObtenerPreciosResponse", namespace = "http://services.superdiscows.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerPreciosResponse", namespace = "http://services.superdiscows.das.ubp.edu.ar/")
