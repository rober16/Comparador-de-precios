...
@XmlRootElement(name = "ObtenerProductosResponse", namespace = "http://services.superveaws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerProductosResponse", namespace = "http://services.superveaws.das.ubp.edu.ar/")
