...
@XmlRootElement(name = "ObtenerSucursalesResponse", namespace = "http://services.superveaws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerSucursalesResponse", namespace = "http://services.superveaws.das.ubp.edu.ar/")
