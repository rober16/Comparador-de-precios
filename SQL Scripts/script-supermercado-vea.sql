...
('62941', 'Super Vea','Av. Acuña Mosto', 50,'03571430511')
go
...
INSERT INTO marcas_productos (nro_marca, nom_marca, vigente) VALUES
...
values 
('Supermercado Vea Sucursal I', 'Av. ACUÑA MODESTO', 50, '03571430511', -32.17258426887961, -64.10994530064355, 9, 1),
('Supermercado Vea Sucursal II', 'Av. FUERZA AEREA ARGENTINA ', 2080, '3514333354', -31.43039154292319, -64.21889721872991, 1, 1),
('Supermercado Vea Sucursal III', 'Av. OLMOS EMILIO', 78, '3514331015', -31.414044810229413, -64.18209801027254, 1, 1),
('Supermercado Vea Sucursal IV', 'RUTA NACIONAL 9', 0, '011-4733-1000', -32.92263495423215, -60.80202049812699, 15, 1);
go
...
VALUES
-- Supermercado Vea Sucursal I
(1, '10000001', 750.50, 1), -- Pan Blanco Bimbo
(1, '10000002', 1680.00, 1), -- Pan Integral Fargo
(1, '10000003', 2950.00, 1), -- Galletitas Dulces Bagley
(1, '10000004', 2710.00, 1),  -- Arroz Gallo Cl�sico
(1, '10000005', 1420.00, 1), -- Fideos Matarazzo
(1, '20000001', 2700.00, 1), -- Papa Congelada McCain

-- Supermercado Vea Sucursal II
(2, '20000002', 885.00, 1),  -- Lentejas Arcor
(2, '30000001', 2200.00, 1), -- Carne Roja Swift
(2, '30000002', 1500.00, 1), -- Huevos San Sebasti�n
(2, '40000001', 1600.00, 1), -- Leche La Seren�sima
(2, '40000002', 4500.00, 1), -- Queso Cremoso La Paulina

-- Supermercado Vea Sucursal III
(3, '50000001', 3080.00, 1), -- Aceite Natura
(3, '60000001', 900.50, 1), -- Az�car Ledesma
(3, '60000002', 2070.00, 1), -- Dulce de Batata Arcor
(3, '70000001', 2500.00, 1), -- Coca-Cola Light
(3, '70000002', 8500.00, 1), -- Caf� Cabrales

-- Supermercado Vea Sucursal IV
(4, '70000003', 6000.00, 1), -- Yerba Mate Tarag��
(4, '10000001', 750.50, 1), -- Pan Blanco Bimbo
(4, '20000002', 885.00, 1),  -- Lentejas Arcor
(4, '30000001', 2200.00, 1), -- Carne Roja Swift
(4, '60000002', 2070.00, 1); -- Dulce de Batata Arcor
GO
...
-- Orgánicos
(1, 1, 1), -- Bimbo produce productos org�nicos
(27, 1, 1), -- Sancor produce productos org�nicos
-- Sin TACC
...
-- Ecol�gicos
(32, 6, 1), -- Cocinero produce productos ecol�gicos
(48, 6, 1); -- Rosamonte produce productos ecol�gicos
